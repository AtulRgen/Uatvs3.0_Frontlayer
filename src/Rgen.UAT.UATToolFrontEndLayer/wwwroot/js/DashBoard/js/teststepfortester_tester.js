...
var teststepfortester = {
    ...
    lastTestingTestStep: function ()//Added for rating feature 
    {
		...
		"<br/><div class='center' style='padding-top:7px'><a style='color:#0000FF;text-decoration:underline;cursor:pointer;' href='feedback.aspx?keys=" + teststepfortester.searchProjectKey + "" + teststepfortester.searchTestPassKey + "," + teststepfortester.searchRoleKey + "'>Review my Results and Provide Feedback</a>" +
    ...
    openRatingPopupAfterTestingComplete: function () {
        ...
        $('#FeedbackPopUpRTE').dialog({
            height: 400, width: 350, resizable: false, modal: true, buttons: {
                "Save": function () {
                    Main.showLoading();
                    updateRTE('rte3');
    ...
    showUpload: function () {
        $('#upload').dialog({ height: 275, width: 450, resizable: false, title: "Testing", modal: true, close: function () { teststepfortester.renewUploadPopup() } });
    ...
    renewUploadPopup: function () {
        ...
        $('#attachmentsOnClient').empty().html('<input style="width: 200pt;" id="onetidIOFile" class="ms-fileinput" title="Browse" name="fileupload0" size="56" type="file">');
    ...
    FeedbackRedirect: function () {
        var path = "feedback.aspx?keys=" + teststepfortester.searchProjectKey + "," + teststepfortester.searchTestPassKey + "," + teststepfortester.searchRoleKey + "";
        ...
        $('#divAlert').dialog({
            ...
            buttons: {
                "Go to Feedback": function () {
                    ...
                    var url = Main.getSiteUrl() + '/SitePages/feedback.aspx?tsfd=1&key=' + teststepfortester.searchProjectKey + ',' + teststepfortester.searchTestPassKey + ',' + teststepfortester.searchRoleKey;
