...
pageLoad:function()
{
   ...
   //}
	...
	{
	   var imgStr = '_layouts/15/images/spimn.png';
	...
	if(isRootWeb)
	{
		switch(pageName)
		{
			...
			case "dashboard-stakeholder":$(".adv").html('<img style="width:1024px" alt="Customized banner goes here" src="../SiteAssets/theme/'+themeColor+'/images/banner-dashboard.jpg" complete="complete"/>');
							 break;
			case "report_new":$(".adv").html('<img style="width:1024px" alt="Customized banner goes here" src="../SiteAssets/theme/'+themeColor+'/images/banner-dashboard.jpg" complete="complete"/>');
							 break;
	
			case "analysis":$(".adv").html('<img style="width:1024px" alt="Customized banner goes here" src="../SiteAssets/theme/'+themeColor+'/images/banner-Analysis.jpg" complete="complete"/>');
							 break;
			case "attachment_1":$(".adv").html('<img style="width:1024px" alt="Customized banner goes here" src="../SiteAssets/theme/'+themeColor+'/images/banner-Attachments.jpg" complete="complete"/>');
							 break;
			case "configuration":$(".adv").html('<img style="width:1024px" alt="Customized banner goes here" src="../SiteAssets/theme/'+themeColor+'/images/banner-Configuration.jpg" complete="complete"/>');
									 break;
			case "feedback":$(".adv").html('<img style="width:1024px" alt="Customized banner goes here" src="../SiteAssets/theme/'+themeColor+'/images/banner-Feedback.jpg" complete="complete"/>');
									 break;
			case "projectmgnt_1":$(".adv").html('<img style="width:1024px" alt="Customized banner goes here" src="../SiteAssets/theme/'+themeColor+'/images/banner-projects.jpg" complete="complete"/>');
									 break;
			case "query":$(".adv").html('<img style="width:1024px" alt="Customized banner goes here" src="../SiteAssets/theme/'+themeColor+'/images/banner-query.jpg" complete="complete"/>');
									 break;
			case "report":$(".adv").html('<img style="width:1024px" alt="Customized banner goes here" src="../SiteAssets/theme/'+themeColor+'/images/banner-reports.jpg" complete="complete"/>');
									 break;
			case "testcase_1":$(".adv").html('<img style="width:1024px" alt="Customized banner goes here" src="../SiteAssets/theme/'+themeColor+'/images/banner-Testcases.jpg" complete="complete"/>');
									 break;
			case "tester_1":$(".adv").html('<img style="width:1024px" alt="Customized banner goes here" src="../SiteAssets/theme/'+themeColor+'/images/banner-Testers.jpg" complete="complete"/>');
									 break;
			case "tester":$(".adv").html('<img style="width:1024px" alt="Customized banner goes here" src="../SiteAssets/theme/'+themeColor+'/images/banner-Testing.jpg" complete="complete"/>');
									 break;
			case "testpassmgnt_1":$(".adv").html('<img style="width:1024px" alt="Customized banner goes here" src="../SiteAssets/theme/'+themeColor+'/images/banner-Testpasses.jpg" complete="complete"/>');
									 break;
			case "teststep_1":$(".adv").html('<img style="width:1024px" alt="Customized banner goes here" src="../SiteAssets/theme/'+themeColor+'/images/banner-TestSteps.jpg" complete="complete"/>');
									 break;
			case "triage":$(".adv").html('<img style="width:1024px" alt="Customized banner goes here" src="../SiteAssets/theme/'+themeColor+'/images/banner-triage.jpg" complete="complete"/>');
							 break;
			case "yammer":$(".adv").html('<img style="width:1024px" alt="Customized banner goes here" src="../SiteAssets/theme/'+themeColor+'/images/banner_yammer.jpg" complete="complete"/>');
							 break;
